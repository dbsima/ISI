					...
					echo '<tr>
						<td>
							<div class="input-group">
							  ...
							  <input type="text" class="form-control" placeholder="Proiect">
							</div>
						</td>
						<td>
							<div class="input-group">
						...
						<td>
							<div class="input-group">
							  ...
							  <input type="text" class="form-control" placeholder="Ore">
							</div>
						</td>
